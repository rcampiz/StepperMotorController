...
// Import harness type into Services namespace for backward compatibility
using Harness::EncoderStatus;
 ...
 */
class ControlModeManager : public Harness::IEncoderStatusSink {
public:
  /**
   ...
   */
  void setEncoderStatus(EncoderStatus status) override;
