...
private:
    ...
    void configurePins() {
        if (m_spi == SPI1) {
            configureAF(Pins::SPI1_Bus::PORT, Pins::SPI1_Bus::SCK_PIN,  Pins::SPI1_Bus::AF);
            configureAF(Pins::SPI1_Bus::PORT, Pins::SPI1_Bus::MISO_PIN, Pins::SPI1_Bus::AF);
            configureAF(Pins::SPI1_Bus::PORT, Pins::SPI1_Bus::MOSI_PIN, Pins::SPI1_Bus::AF);
        } else if (m_spi == SPI2) {
            configureAF(Pins::SPI2_Bus::PORT, Pins::SPI2_Bus::SCK_PIN,  Pins::SPI2_Bus::AF);
            configureAF(Pins::SPI2_Bus::PORT, Pins::SPI2_Bus::MISO_PIN, Pins::SPI2_Bus::AF);
            configureAF(Pins::SPI2_Bus::PORT, Pins::SPI2_Bus::MOSI_PIN, Pins::SPI2_Bus::AF);
        }
    }
