...
arm-none-eabi-g++ -c %CXXFLAGS% server/foundation/F_platform/types/telemetry.cpp -o build/telemetry.o
...
echo [20/23] Compiling wiring sources...
...
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_motion.cpp -o build/sd_motion.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_motion.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_safety.cpp -o build/sd_safety.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_safety.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_queue.cpp -o build/sd_queue.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_queue.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_config.cpp -o build/sd_config.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_config.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_control_mode.cpp -o build/sd_control_mode.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_control_mode.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_encoder.cpp -o build/sd_encoder.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_encoder.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_display.cpp -o build/sd_display.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_display.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_flash.cpp -o build/sd_flash.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_flash.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_supervisor_trim.cpp -o build/sd_supervisor_trim.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_supervisor_trim.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_motor_driver.cpp -o build/sd_motor_driver.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_motor_driver.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_system.cpp -o build/sd_system.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_system.cpp & exit /b 1)
arm-none-eabi-g++ -c %CXXFLAGS% server/wiring/sd_trace.cpp -o build/sd_trace.o
if %ERRORLEVEL% NEQ 0 (echo ERROR: Failed to compile sd_trace.cpp & exit /b 1)

echo [21/23] Assembling startup_stm32f401xe.s...
...
echo [22/23] Collecting object files...
...
set "OBJS=%OBJS% build/sd_motion.o build/sd_safety.o build/sd_queue.o build/sd_config.o build/sd_control_mode.o build/sd_encoder.o"
set "OBJS=%OBJS% build/sd_display.o build/sd_flash.o build/sd_supervisor_trim.o build/sd_motor_driver.o build/sd_system.o build/sd_trace.o"
